...
urlpatterns = patterns('met.metadataparser.views',
    ...
    url(r'^federation/(?P<federation_id>\d+)/$', 'federation_view', name='federation_view'),
    url(r'^federation/(?P<federation_id>\d+)/edit/$', 'federation_edit', name='federation_edit'),
    url(r'^federation/add/$', 'federation_edit', name='federation_add'),
    url(r'^federation/(?P<federation_id\d)/entities/$', include(entity_urlpatterns),
    )
