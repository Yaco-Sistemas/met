...
urlpatterns = patterns('met.metadataparser.views',
    ...
    url(r'^federation/(?P<federation_slug>[-\w]+)/entityadd/$', 'entity_edit',
        name='entity_add'),
    url(r'^entity/(?P<entity_slug>[-\w]+)/$', 'entity_view', name='entity_view'),
    url(r'^entity/(?P<entity_slug>[-\w]+)/edit/$', 'entity_edit',
        name='entity_edit'),
    url(r'^entity/(?P<entity_slug>[-\w]+)/delete/$', 'entity_delete',
        name='entity_delete'),
